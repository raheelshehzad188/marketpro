...
Route::get('/style-quiz/start', 'HomeController@start_style_quiz')->name('start_style_quiz');
Route::post('/cart/addtocart-quiz', 'CartController@quizCart')->name('cart.quiz');
...
Route::get('/style-quiz/results/{id}', 'HomeController@results_style_quiz')->name('results_style_quiz');

Route::get('/confirm-order', 'HomeController@confirm_order')->name('confirm_order');
Route::get('/thank-you', 'HomeController@thank_you')->name('thank_you');

Route::get('/package/{slug}', 'HomeController@package_detail')->name('package_detail');
Route::get('/packages', 'HomeController@packages')->name('packages');
Route::post('/packages/total', 'HomeController@package_total')->name('package.total');

Route::get('/water-savings', 'HomeController@water_savings')->name('water_savings');

Route::get('/portfolio', 'HomeController@portfolio')->name('portfolio');
//Route::get('/load-portfolio-data','HomeController@portfolio')->name('portfolio.list');
Route::post('/load-portfolio-data', 'HomeController@loadMorePortolioData')->name('load-portolio-data');

Route::get('/portfolio/{slug}', 'HomeController@portfolio_detail')->name('portfolio_detail');

Route::get('/client-reviews', 'HomeController@reviews')->name('client-reviews');

Route::get('/how-it-works', 'HomeController@how_it_works')->name('how_ite_works');

Route::get('/rebates', 'HomeController@rebates')->name('rebates');

Route::get('/blog', 'BlogController@all_blogs')->name('blogs');
Route::get('/blog/{slug}', 'BlogController@blog_details')->name('blog.details');

Route::get('/contact-us', 'HomeController@contact_us')->name('contact-us');

Route::get('/style-quiz', 'HomeController@take_quiz')->name('style_quiz');
