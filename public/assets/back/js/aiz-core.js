  ...
  AIZ.plugins = {
    ...
    bootstrapSelect: function (refresh = "") {
      $(".aiz-selectpicker").each(function (el) {
        var $this = $(this)
        var exactMatchSku = $this.data("exact-match-sku")
        ...
        // Exact SKU match functionality
        if (exactMatchSku) {
          $this.data("selectpicker").$searchbox.on("input", function () {
            ...
            options.each(function () {
              ...
              if (
                option.data("sku") &&
                option.data("sku").toString().toLowerCase() === searchValue
              ) {
                $this.val(option.val())
                $this.selectpicker("refresh")
