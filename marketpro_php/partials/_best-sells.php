                ...
                <div class="col-xxl-8">
                    ...
                    <div class="row gy-4">
                        <?php foreach ($products as $index => $product): ?>
                            <div class="col-md-6" data-aos="fade-up" data-aos-duration="<?php echo 200 * ($index + 1); ?>">
                                <div class="product-card style-two h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2 flex-align gap-16">
                                    <div class="">
                                        ...
                                        <div class="countdown" id="countdown<?php echo  $index+10; ?>">
                                    ...
                                    <div class="product-card__content">
                                        <div class="product-card__price mb-16">
                                            <span class="text-gray-400 text-md fw-semibold text-decoration-line-through"> <?php echo $product['price']; ?></span>
                                        ...
                                        <div class="mt-12">
                                            ...
                                            <span class="text-gray-900 text-xs fw-medium mt-8">Sold: <?php echo $product['sold']; ?></span>
                                        </div>
                ...
                <div class="col-xxl-4" data-aos="zoom-in" data-aos-duration="600">
                    <div class="position-relative rounded-16 bg-light-purple overflow-hidden p-28 z-1 h-100">
                        ...
                        <div class="py-xl-4">
                            ...
                            <a href="shop.php" class="mt-16 btn bg-success-600 hover-text-white hover-bg-success-700 text-white fw-medium d-inline-flex align-items-center rounded-pill gap-8" tabindex="0">
                                Shop Now
