 ...
 <section class="checkout py-80">
    <div class="container container-lg">
        <div class="border border-gray-100 rounded-8 px-30 py-20 mb-40"> 
            <span class="">Have a coupon? <a href="cart.php" class="fw-semibold text-gray-900 hover-text-decoration-underline hover-text-main-600">Click here to enter your code</a> </span>
        </div>
        <div class="row">
            <div class="col-xl-9 col-lg-8">
                <form action="#" class="pe-xl-5">
                    <div class="row gy-3">
                        ...
                        <div class="col-12">
                            <input type="text" class="common-input border-gray-100" placeholder="Apartment, suite, unit, etc. (Optional)">
                        </div>
                        <div class="col-12">
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="checkout-sidebar">
                    ...
                    <a href="checkout.php" class="btn btn-main mt-40 py-18 w-100 rounded-8 mt-56">Place Order</a>
