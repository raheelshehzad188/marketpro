                ...
                <div class="card-body">
                    <form id="add_form" class="form-horizontal" action="{{ route('blog.store') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" placeholder="{{ translate('Blog Title') }}"
                                    onkeyup="makeSlug(this.value)" id="title" name="title" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group row" id="category">
                            ...
                            <div class="col-md-9">
                                <select class="form-control aiz-selectpicker" name="category[]" id="category_id"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="date" placeholder="{{ translate('Blog Date') }}"
                                  id="title" name="blog_date" class="form-control" required>
                            </div>
                        </div>
