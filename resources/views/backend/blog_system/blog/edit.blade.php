                ...
                <div class="card-body">
                    <form id="add_form" class="form-horizontal" action="{{ route('blog.update', $blog->id) }}"
                        ...
                        <div class="form-group row" id="category">
                            ...
                            <div class="col-md-9">
                                <select class="form-control aiz-selectpicker" multiple name="category[]" id="category_id"
                                    data-live-search="true" required data-selected="{{ json_encode($selected_categories) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="date" placeholder="{{ translate('Blog Date') }}" id="title" name="blog_date"
                                    value="{{ $blog->blog_date }}" class="form-control">
                            </div>
                        </div>
