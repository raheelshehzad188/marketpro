    ...
    <div class="card">
        <form class="p-4" action="{{ route('custom-pages.update', $page->id) }}" method="POST"
            ...
            <div class="card-body px-0">
                ...
                <div class="form-group row">
                    <label for="visibility" class="col-sm-2 col-from-label">Visibility</label>
                    <div class="col-sm-10">
                        <select class="aiz-selectpicker w-100" id="visibility"
                            data-selected="{{ json_encode($visibilityShopIds) }}" name="visibility[]" multiple>
