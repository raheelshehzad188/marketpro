...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <br>
            <div class="">
                <a href="{{ static_asset('download/product_bulk_sample.xlsx') }}" target="blank"><button class="btn btn-info">{{ translate('Download CSV')}}</button></a>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6"><strong>{{translate('Upload Tags File')}}</strong></h5>
        </div>
        <div class="card-body">
