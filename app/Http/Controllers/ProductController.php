...
class ProductController extends Controller
{
    ...
    public function admin_product_edit(Request $request, $id)
    {
        ...
        $categories = Category::where('parent_id', 0)->where('digital', 0)->with('childrenCategories')->orderBy('id', 'DESC')->get();
        $selected_categories = $product->categories()->pluck('category_id')->toArray();
        $selected_addons = \DB::table('product_addon_pivot')->where('product_id', $id)->pluck('product_addon_id')->toArray();


        return view('backend.product.products.edit', compact('product', 'categories', 'tags', 'lang', 'selected_categories', 'selected_addons'));
    }
